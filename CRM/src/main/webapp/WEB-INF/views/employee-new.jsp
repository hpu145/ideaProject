        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/employee"><i class="fa fa-circle-o"></i> 部门管理</a></li>
                        <li><a href="/employee"><i class="fa fa-circle-o"></i> 员工管理</a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form action="/employee_new" id="newEmployeeForm" method="post">
