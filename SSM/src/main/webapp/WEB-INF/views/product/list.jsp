        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-inline">
                    ...
                    <input type="text" name="minPrice" placeholder="最低价" class="form-control" value="${param.minPrice}"> —
                    <input type="text" name="maxPrice" placeholder="最高价" class="form-control" value="${param.maxPrice}">
